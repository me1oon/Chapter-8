...
public class MainActivity extends AppCompatActivity {
    ...
    private String myId = "18888916440";
    private String myName = "me1on";
        ...
        miniDouyinService.getVideos().enqueue(new Callback<GetVideosResponse>() {
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    Iterator<Video> itVideo = mVideos.iterator();
                    while(true) {
                        if(itVideo.hasNext()){
                            Video nextVideo = itVideo.next();
                            if(myId != nextVideo.studentId){
                                itVideo.remove();
                            }
                        }
                        else{
